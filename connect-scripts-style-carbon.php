...
function add_all_styles() {
	...
	wp_enqueue_style( 'panda-store-main', get_template_directory_uri().'/css/style-theme.css?ver='.time() );
...
function add_all_scripts() {
	...
	wp_enqueue_script( 'common-js', get_template_directory_uri() . '/common-dist.js');
